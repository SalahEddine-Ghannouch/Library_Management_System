        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" class="form-control" name="keyword" placeholder="Rechercher un livre, un auteur ou une catégorie" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;margin-bottom:0px;"> '. $author .' Magasin </h2>
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
                  <div class="col-sm-5 col-sm-offset-6 col-md-5 col-md-offset-7 col-lg-4 col-lg-offset-8">
                       <form action="';echo $_SERVER['PHP_SELF'];echo'" method="post" class="pull-right">
                           <label for="sort">Trier par &nbsp: &nbsp</label>
                            <select name="sort" onchange="form.submit()">
                                <option value="default" name="default"  selected="selected">Select</option>
                                <option value="price" name="price">page: bas en haut </option>
                                <option value="priceh" name="priceh">page: haut en bas </option>
                                <option value="discountl" name="discountl">Ancienneté: bas en haut </option>
                                <option value="discount" name="discount">Ancienneté: haut en bas</option>
                            </select>
                       </form>
                  </div>
              </div>
