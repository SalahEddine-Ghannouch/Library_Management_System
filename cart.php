        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Commande réussie Rendez-vous à l'école pour régler la demande. ");
                    </script>
                 <?php                  
                  }
	        ...
	        if(!isset($_SESSION['user']))
	          {
	            ...
	            echo' <li> <a href="destroy.php" class="btn btn-lg"> Se déconnecter </a> </li>';
	        ?>
...
echo '<div class="container-fluid" id="cart">
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;"> VOTRE CARTE </h2>
           </div>
        </div>';
	if(isset($_SESSION['user']))
	    {   
                             ...
                             if($j%2==0)
                                 ...
                                 echo '                
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-'.$offset.' col-md-4 col-md-offset-'.$offset.' col-lg-4 col-lg-offset-'.$offset.' text-center" style="color:#D67B22;font-weight:800;">
                                          <div class="panel-heading">élément '. $i .'
                                          </div>
                                          <div class="panel-body" style="text-align:justify;">
			                                               <center> <img class="image-responsive block-center" src="'.$path.'" style="height :100px;text-align:center;"> </center><br>
           							                                               ¤ Titre : '.$row['Title'].'  <br> 
                                                                        ¤ Code : '.$row['PID'].'     <br>        	 
                                                      									¤ Auteur(e) : '.$row['Author'].' <br>                            	      
                                                      									¤ Edition : '.$row['Edition'].' <br>
                                                                     <center>  <a href="cart.php?remove='.$row['PID'].'" class="btn btn-sm" 
                    ...
                    echo '<div class="container">
                     ...
                     echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Continuer la demande</a>
                             </div>
                             <div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-1 col-lg-4 ">
                                  <a href="cart.php?place=true" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;margin-top:5px;">Terminé votre carte</a>
                             </div>
                           </div>
                           ';
                } 
                        ...
                        echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#D67B22;font-weight:bold;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                                 &nbsp &nbsp  &nbsp &nbsp &nbspTerminé</span>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Faire une demande</a>
                             </div>
                          </div>';
                     }               
	    }
